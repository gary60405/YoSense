...
Blockly.JavaScript['text_join'] = function(block) {
  ...
  switch (block.itemCount_) {
    ...
    case 1:
      try {
        var element = Blockly.JavaScript.statementToCode(block, 'ADD0', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
      }
      catch(e) {
    ...
    case 2:
      try {
        var element0 = Blockly.JavaScript.statementToCode(block, 'ADD0', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
      }
      catch(e) {
        var element0 = Blockly.JavaScript.valueToCode(block, 'ADD0', Blockly.JavaScript.ORDER_NONE) || '\'\'';
      }
      try {
        var element1 = Blockly.JavaScript.statementToCode(block, 'ADD1', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
      }
      catch(e) {
    ...
    default:
      ...
      for (var i = 0; i < block.itemCount_; i++) {
        try {
          elements[i] = Blockly.JavaScript.statementToCode(block, 'ADD' + i, Blockly.JavaScript.ORDER_COMMA).trim() || '\'\''; 
        }
        catch(e) {
...
Blockly.JavaScript['text_append'] = function(block) {
  ...
  try {
    var value = Blockly.JavaScript.statementToCode(block, 'TEXT', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
  }
  catch(e) {
...
Blockly.JavaScript['text_length'] = function(block) {
  ...
  try {
    var text = Blockly.JavaScript.statementToCode(block, 'VALUE', Blockly.JavaScript.ORDER_FUNCTION_CALL).trim() || '\'\'';
  }
  catch(e) {
...
Blockly.JavaScript['text_isEmpty'] = function(block) {
  ...
  try {
    var text = Blockly.JavaScript.statementToCode(block, 'VALUE', Blockly.JavaScript.ORDER_MEMBER).trim() || '\'\'';  
  }
  catch(e) {
...
Blockly.JavaScript['text_indexOf'] = function(block) {
  ...
  var operator = block.getFieldValue('END') == 'FIRST' ?
      'indexOf' : 'lastIndexOf';
  try {
    var substring = Blockly.JavaScript.statementToCode(block, 'FIND', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
  }
  catch(e) {
...
Blockly.JavaScript['text_charAt'] = function(block) {
  ...
  try {
    var text = Blockly.JavaScript.statementToCode(block, 'VALUE', textOrder).trim() || '\'\''; 
  }
  catch(e) {
...
Blockly.JavaScript['text_getSubstring'] = function(block) {
  // Get substring.
  try {
    var text = Blockly.JavaScript.statementToCode(block, 'STRING', Blockly.JavaScript.ORDER_FUNCTION_CALL).trim() || '\'\''; 
  }
  catch(e) {
...
Blockly.JavaScript['text_changeCase'] = function(block) {
  ...
  try {
    var text = Blockly.JavaScript.statementToCode(block, 'TEXT', textOrder).trim() || '\'\'';  
  }
  catch(e) {
...
Blockly.JavaScript['text_trim'] = function(block) {
  ...
  var text = Blockly.JavaScript.statementToCode(block, 'TEXT',
      Blockly.JavaScript.ORDER_MEMBER).trim() || '\'\'';
...
Blockly.JavaScript['text_print'] = function(block) {
  // Print statement.
  try {
    var msg = Blockly.JavaScript.statementToCode(block, 'TEXT', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';  
  }
  catch(e) {
    var msg = Blockly.JavaScript.valueToCode(block, 'TEXT', Blockly.JavaScript.ORDER_NONE) || '\'\'';  
  }
  
  return 'console.log(' + msg.replace(';','') + ');\n';
};
...
Blockly.JavaScript['text_count'] = function(block) {
  try {
    var text = Blockly.JavaScript.statementToCode(block, 'TEXT', Blockly.JavaScript.ORDER_MEMBER).trim() || '\'\'';
  }
  catch(e) {
    var text = Blockly.JavaScript.valueToCode(block, 'TEXT', Blockly.JavaScript.ORDER_MEMBER) || '\'\'';
  }
  try {
    var sub = Blockly.JavaScript.statementToCode(block, 'SUB', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
  }
  catch(e) {  
...
Blockly.JavaScript['text_replace'] = function(block) {
  ...
  try {
    var from = Blockly.JavaScript.statementToCode(block, 'FROM', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
  }
  catch(e) {
    var from = Blockly.JavaScript.valueToCode(block, 'FROM', Blockly.JavaScript.ORDER_NONE) || '\'\'';
  }
  try {
    var to = Blockly.JavaScript.statementToCode(block, 'TO', Blockly.JavaScript.ORDER_NONE).trim() || '\'\''; 
  }
  catch(e) {
  ...
  var functionName = Blockly.JavaScript.provideFunction_(
      ...
      ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
       ...
       '}']);
  var code = functionName + '(' + text + ', ' + from.replace(');', ')') + ', ' + to.replace(');', ')') + ')';
