...
Blockly.JavaScript['math_arithmetic'] = function(block) {
  ...
  var order = tuple[1];
  try {
    var argument0 = Blockly.JavaScript.statementToCode(block, 'A', order).trim() || '0'; 
  }
  catch(e) {
    var argument0 = Blockly.JavaScript.valueToCode(block, 'A', order) || '0';
  }
  try {
    var argument1 = Blockly.JavaScript.statementToCode(block, 'B', order).trim()  || '0';
  }
  catch(e) {
...
Blockly.JavaScript['math_single'] = function(block) {
  ...
  if (operator == 'NEG') {
    ...
    try {
      arg = Blockly.JavaScript.statementToCode(block, 'NUM', Blockly.JavaScript.ORDER_UNARY_NEGATION).trim() || '0';
    }
    catch(e) {
  ...
  if (operator == 'SIN' || operator == 'COS' || operator == 'TAN') {
    try {
      arg = Blockly.JavaScript.statementToCode(block, 'NUM', Blockly.JavaScript.ORDER_DIVISION).trim() || '0';
    }
    catch(e) {
      ...
      try {
        arg = Blockly.JavaScript.statementToCode(block, 'NUM', Blockly.JavaScript.ORDER_NONE).trim() || '0';
      }
      catch(e) {
  ...
  return [code.replace(');', ')'), Blockly.JavaScript.ORDER_DIVISION];
};
...
Blockly.JavaScript['math_number_property'] = function(block) {
  ...
  try {
    var number_to_check = Blockly.JavaScript.statementToCode(block, 'NUMBER_TO_CHECK', Blockly.JavaScript.ORDER_MODULUS).trim() || '0';
  }
  catch(e) {
  ...
  switch (dropdown_property) {
    ...
    case 'DIVISIBLE_BY':
      try {  
        var divisor = Blockly.JavaScript.statementToCode(block, 'DIVISOR', Blockly.JavaScript.ORDER_MODULUS).trim() || '0';
      }
      catch(e) {
  ...
  return [code.replace(');', ')'), Blockly.JavaScript.ORDER_EQUALITY];
};

Blockly.JavaScript['math_change'] = function(block) {
  // Add to a variable in place.
  try {
    var argument0 = Blockly.JavaScript.statementToCode(block, 'DELTA', Blockly.JavaScript.ORDER_ADDITION).trim() || '0'; 
  }
  catch(e) {
...
Blockly.JavaScript['math_on_list'] = function(block) {
  ...
  switch (func) {
    case 'SUM':
      try {
        list = Blockly.JavaScript.statementToCode(block, 'LIST', Blockly.JavaScript.ORDER_MEMBER).trim() || '[]';
      }
      catch(e) {
    ...
    case 'MIN':
      try {
        list = Blockly.JavaScript.statementToCode(block, 'LIST', Blockly.JavaScript.ORDER_COMMA).trim() || '[]';
      }
      catch(e) {
    ...
    case 'AVERAGE':
      ...
      var functionName = Blockly.JavaScript.provideFunction_(
          ...
          ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
            ...
            '}']);
      try {
        list = Blockly.JavaScript.statementToCode(block, 'LIST', Blockly.JavaScript.ORDER_NONE).trim() || '[]';
      }
      catch(e) {
...
Blockly.JavaScript['math_modulo'] = function(block) {
  ...
  return [code.replace(');', ')'), Blockly.JavaScript.ORDER_MODULUS];
};
...
Blockly.JavaScript['math_constrain'] = function(block) {
  ...
  try {
    ...
    var argument0 = Blockly.JavaScript.statementToCode(block, 'VALUE', Blockly.JavaScript.ORDER_COMMA).trim() || '0';
  }
  catch(e) {
  ...
  try {
    ...
    var argument1 = Blockly.JavaScript.statementToCode(block, 'LOW', Blockly.JavaScript.ORDER_COMMA).trim() || '0';
  }
  catch(e) {
    var argument1 = Blockly.JavaScript.valueToCode(block, 'LOW', Blockly.JavaScript.ORDER_COMMA) || '0';
  }
  try {
    var argument2 = Blockly.JavaScript.statementToCode(block, 'HIGH', Blockly.JavaScript.ORDER_COMMA).trim() || 'Infinity'; 
  }
  catch(e) {
  ...
  var code = 'Math.min(Math.max(' + argument0 + ', ' + argument1 + '), ' +
      argument2 + ')';
  return [code.replace(');', ')'), Blockly.JavaScript.ORDER_FUNCTION_CALL];
};

Blockly.JavaScript['math_random_int'] = function(block) {
  // Random integer between [X] and [Y].
  try {
    var argument0 = Blockly.JavaScript.statementToCode(block, 'FROM', Blockly.JavaScript.ORDER_COMMA).trim() || '0';
  }
  catch(e) {
    var argument0 = Blockly.JavaScript.valueToCode(block, 'FROM', Blockly.JavaScript.ORDER_COMMA) || '0';
  }
  try {
    var argument1 = Blockly.JavaScript.statementToCode(block, 'TO', Blockly.JavaScript.ORDER_COMMA).trim() || '0';
  }
  catch(e) {
