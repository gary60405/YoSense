...
Blockly.JavaScript['lists_create_with'] = function(block) {
  ...
  for (var i = 0; i < block.itemCount_; i++) {
    try {
        elements[i] = Blockly.JavaScript.statementToCode(block, 'ADD' + i,Blockly.JavaScript.ORDER_COMMA).trim() || 'null';     
    }
    catch(e) {
        elements[i] = Blockly.JavaScript.valueToCode(block, 'ADD' + i,Blockly.JavaScript.ORDER_COMMA) || 'null';  
    }
  }
  var code = '[' + elements.map(element => `'${element}'`).join(', ') + ']';
...
Blockly.JavaScript['lists_repeat'] = function(block) {
  ...
  var functionName = Blockly.JavaScript.provideFunction_(
      ...
      ['function ' + Blockly.JavaScript.FUNCTION_NAME_PLACEHOLDER_ +
       ...
       '}']);
    try {
        var element = Blockly.JavaScript.statementToCode(block, 'ITEM',
        Blockly.JavaScript.ORDER_COMMA).trim() || 'null';    
    }
    catch(e) {
    ...
    try {
        var repeatCount = Blockly.JavaScript.statementToCode(block, 'NUM',
        Blockly.JavaScript.ORDER_COMMA).trim() || '0'; 
    }
    catch(e) {
  ...
  var code = functionName + '(' + element + ', ' + repeatCount.replace(');', ')') + ')';
...
Blockly.JavaScript['lists_length'] = function(block) {
  // String or array length.
    try {
        var list = Blockly.JavaScript.statementToCode(block, 'VALUE',
...
Blockly.JavaScript['lists_indexOf'] = function(block) {
  ...
  var operator = block.getFieldValue('END') == 'FIRST' ?
      'indexOf' : 'lastIndexOf';
  try {
    var item = Blockly.JavaScript.statementToCode(block, 'FIND',
    Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
  }
  catch(e) {
  ...
  var code = list + '.' + operator + '(' + item.replace(');', ')') + ')';
...
Blockly.JavaScript['lists_getIndex'] = function(block) {
  ...
  var where = block.getFieldValue('WHERE').replace(');', ')') || 'FROM_START';
  var listOrder = (where == 'RANDOM') ? Blockly.JavaScript.ORDER_COMMA :
      Blockly.JavaScript.ORDER_MEMBER;
  try {
    var list = Blockly.JavaScript.statementToCode(block, 'VALUE', listOrder).trim() || '[]';
  }
  catch(e) {
...
Blockly.JavaScript['lists_setIndex'] = function(block) {
  ...
  try { 
    var list = Blockly.JavaScript.statementToCode(block, 'LIST', Blockly.JavaScript.ORDER_MEMBER).trim() || '[]'; 
  }
  catch(e) {
  ...
  var where = block.getFieldValue('WHERE').replace(');', ')') || 'FROM_START';
  try { 
    var value = Blockly.JavaScript.statementToCode(block, 'TO', Blockly.JavaScript.ORDER_ASSIGNMENT).trim() || 'null';  
  }
  catch(e) {
...
Blockly.JavaScript['lists_getSublist'] = function(block) {
  // Get sublist.
    try {
      var list = Blockly.JavaScript.statementToCode(block, 'LIST',
      Blockly.JavaScript.ORDER_MEMBER).trim() || '[]';  
    }
    catch(e) {
  ...
  var where1 = block.getFieldValue('WHERE1').replace(');', ')');
  var where2 = block.getFieldValue('WHERE2').replace(');', ')');
...
Blockly.JavaScript['lists_sort'] = function(block) {
  ...
  try {
    var list = Blockly.JavaScript.statementToCode(block, 'LIST', Blockly.JavaScript.ORDER_FUNCTION_CALL).trim() || '[]';
  }
  catch(e) {
...
Blockly.JavaScript['lists_split'] = function(block) {
  ...
  try {  
      var input = Blockly.JavaScript.statementToCode(block, 'INPUT', Blockly.JavaScript.ORDER_MEMBER).trim();
  }
  catch(e) {
      var input = Blockly.JavaScript.valueToCode(block, 'INPUT', Blockly.JavaScript.ORDER_MEMBER);
  }
  try {  
      var delimiter = Blockly.JavaScript.statementToCode(block, 'DELIM', Blockly.JavaScript.ORDER_NONE).trim() || '\'\'';
  }
  catch(e) {
